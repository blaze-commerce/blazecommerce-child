...
<!-- wp:group {"metadata":{"name":"Our Expert"},"align":"full","style":{"spacing":{"padding":{"top":"5rem","bottom":"5rem","left":"1.5rem","right":"1.5rem"},"margin":{"top":"0","bottom":"0"}},"color":{"background":"#f9fafb"}},"layout":{"type":"constrained","contentSize":"1200px"}} -->
	...
	<div class="wp-block-columns alignwide items-center">
		...
		<div class="wp-block-column text-center lg:text-left" style="flex-basis:40%">
			...
			<figure class="wp-block-image size-large rounded-2xl shadow-lg aspect-square">
				<img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop&crop=face" alt="<?php echo esc_attr_x( 'Professional Expert Portrait', 'Alt text for expert image', 'blaze-child' ); ?>" style="width:400px;height:400px;object-fit:cover"/>
			</figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column" style="flex-basis:60%">
			...
			<h2 class="wp-block-heading has-text-align-left has-text-color has-cardo-font-family" style="color:#111827;margin-bottom:1.5rem;font-size:2.5rem;font-weight:400;line-height:1.2"><?php echo esc_html_x( 'Meet Our Specialist', 'Expert name heading', 'blaze-child' ); ?></h2>
			<!-- /wp:heading -->
			...
			<p class="has-text-color has-josefin-sans-font-family" style="color:#374151;margin-bottom:2rem;font-size:1.125rem;font-weight:300;line-height:1.75"><?php echo esc_html_x( 'With over 15 years of experience in the industry, our lead specialist brings unparalleled expertise and dedication to every project. Their extensive background spans multiple disciplines and international markets, ensuring innovative solutions that exceed expectations. Today, they lead our team with a commitment to excellence and a passion for delivering exceptional results.', 'Expert description', 'blaze-child' ); ?></p>
			<!-- /wp:paragraph -->
